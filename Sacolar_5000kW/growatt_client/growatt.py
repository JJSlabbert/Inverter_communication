...
def get_from_single_byte(rr, index, scale=0.1):  #scale=0.1
    """Read and scale single to float."""
    return round(float(rr.registers[index]) * scale, 1)


def get_from_double_byte(rr, index, scale=0.1):   #scale=0.1
...
class GrowattClient:
    ...
    async def update_hardware_info(self):
        if self._serial_number == "":
            ...
            self._firmware = get_string(registers, 9, 3) # Check the protocol doc
            self._serial_number = get_string(registers, 23, 5)

            #My own testing (Jaco Slabbert)
            print('Reading applicable registers to get Inverter Hardware and Firmware:')
           
            print('Firmware: ',get_string(registers, 9, 3))
            print('Firmware / Modbus Firmware: ',get_string(registers, 9, 7)) # Including MPPT Charge controler?'
            print('MODBUS Firmware Version: ',get_string(registers, 12, 7))          
            print('Serial Number: ',get_string(registers, 23, 5))       
##            print('Reading registers 0-29')            
##            for i in range(10000):
##                try:
##                    print(str(i),registers.registers[i])
##                except:
##                    print(i, ' No such register.')


##            print(str(0),' ?: ',registers.registers[0])
##            print(str(1),' Output Source Priority: ',registers.registers[1])
##            print(str(2),' Charge Source Priority: ',registers.registers[2],
##                  ' :0=CSO (Solar First),0=CUt (UTILITY FIRST), 1=S&U, 2=OSO (ONLY SOLAR)')           
##            print(str(3),' ?: ',registers.registers[3])
##            print(str(4),' ?: ',registers.registers[4])              
##            print(str(5),' ?: ',registers.registers[5])              
##            print(str(6),' ?: ',registers.registers[6])
##            print(str(7),' ?: ',registers.registers[7])
##            print(str(8),' ?: ',registers.registers[8])              
##            print(str(9),' Firmware: ',registers.registers[9])              
##            print(str(10),' Firmware?: ',registers.registers[10])
##            print(str(11),' Firmware: ',registers.registers[11])
##            print(str(12),' Firmware: ',registers.registers[12])              
##            print(str(13),' Firmware: ',registers.registers[13])              
##            print(str(14),' Firmware: ',registers.registers[14])
##            print(str(15),' ?: ',registers.registers[15])
##            print(str(16),' ?: ',registers.registers[16])              
##            print(str(17),' ?: ',registers.registers[17])              
##            print(str(18),' ?: ',registers.registers[18])
##            print(str(19),' ?: ',registers.registers[19])
##            print(str(20),' ?: ',registers.registers[20])              
##            print(str(21),' ?: ',registers.registers[21])
##            print(str(22),' ?: ',registers.registers[22])
##            print(str(23),' Serial Number: ',registers.registers[23])              
##            print(str(24),' Serial Number: ',registers.registers[24])              
##            print(str(25),' Serial Number: ',registers.registers[25])
##            print(str(26),' Serial Number: ',registers.registers[26])
##            print(str(27),' Serial Number: ',registers.registers[27])              
##            print(str(28),' ?: ',registers.registers[28])
##            print(str(29),' ?: ',registers.registers[29])              
